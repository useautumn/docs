...
Under these conditions, you should allow your customer to use the feature. You can then [record the usage event](/features/tracking-usage/) so Autumn can update the `allowed` field as necessary.
