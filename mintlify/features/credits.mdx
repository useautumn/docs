...
Credit systems allow you to track usage of multiple features with different credit costs from a shared balance pool.
...
Now you can add these credits as a [feature](/products/product-items) within a plan. Such as 50 credits per month or $1 per credit.
...
Autumn will multiple the track `value` by the credit cost you defined, and decrement the credit balance accordingly.
