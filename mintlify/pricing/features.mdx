...
Under the "advanced" section of the feature creation sheet, you can also define [event names](/features/tracking-usage#using-event-names). This gives you more control over how events interact with customer balances in Autumn. 

Metered features can each act as their own, standlone balance, or be added to a [credit system](/pricing/credits). This lets you define credit costs per feature, and let many features draw from a common credit balance. 
