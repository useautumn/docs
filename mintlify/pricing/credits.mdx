...
A credit system is made up of a list of [features](/pricing/features) that can draw from it, and a credit cost per unit of usage for each feature.
...
Since the customer has sufficient credits, you can let them use their 6 "premium requests". Afterwards, you can [track](/api-reference/core/track) the usage to update their balance.
