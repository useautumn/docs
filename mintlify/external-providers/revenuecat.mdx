...
<Steps>
    ...
    ### Map your RevenueCat products to Autumn products
        ...
        <Warning>
            RevenueCat does not support products with the following price types:
            - Prepaid items
            - Usage-based pricing
    ...
    ### Integration
        ...
        **You should not call Autumn's `attach()` or `checkout()` functions. Instead you should either use RevenueCat's SDK or RevenueCat's paywalls.**
        ...
        <Warning>
            You should internally handle blocking existing Autumn users from initiating subscriptions with RevenueCat. Autumn will block this if it detects it,
            however you should still prevent this in your UI.
        </Warning>
        ...
        <Tip>
        if you are using [Expo](https://expo.dev/), you can use Autumn's [React hooks](/api-reference/hooks/useCustomer) too
        </Tip>
