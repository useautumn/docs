...
When you have paying users, you should display a billing page in your app. This typically allows them to change plan, cancel subscription and view their usage.
...
Switching plans follows the same Stripe payment flow as [previously described](/getting-started/sdk). 

<Note>You can alternatively use our pre-built [pricing table component](/getting-started/shadcn#pricing-table) to handle all the various switching scenarios.</Note>
