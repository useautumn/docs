...
<Note>
This guide shows an asynchronous approach to checking and tracking. You can also [check and reserve](/features/check#checking-feature-access-and-recording-usage-together) balance in a single, atomic API call for concurrent events.
</Note>
