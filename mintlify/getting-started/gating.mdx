...
When using [React hooks](/getting-started/react), you have access to the [`customer`](/api-reference/hooks/useCustomer#customer) state object, which you can use to [display billing data](/getting-started/display-billing) to your users (subscription status, feature permissions, usage balances, etc). 
...
<Tip>
You can also use `check` to [gate boolean features](/features/check#checking-boolean-features) (non-metered features), such as access to "premium AI models".
</Tip>
