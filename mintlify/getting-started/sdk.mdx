...
Call the `checkout` function to get Stripe checkout page when the customer wants to purchase the Pro plan, and pass it to your frontend.
...
No matter what scenario: new subscriptions, upgrades, downgrades, renewals, you can always follow this 2 step process.
