...
Call `checkout` to redirect the customer to a Stripe checkout page when they want to purchase the Pro plan, or switch to another plan. Once they've paid, Autumn will grant them access to the features we defined.
