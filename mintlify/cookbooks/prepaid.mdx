...
These are typically one-time purchases that grant a fixed usage of a feature. However, they can also be recurring add-on packs, or 

This gives users a controlled purchase, and allows you to get paid upfront. For these reasons, it tends to be a more popular alternative to "pay-as-you-go" pricing.
