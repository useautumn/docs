...
If their payment details are already on file, [`CheckoutDialog`](/quickstart/shadcn#checkout-dialog) will open instead to let the customer confirm their upgrade, downgrade or new purchase, then handle the payment.
